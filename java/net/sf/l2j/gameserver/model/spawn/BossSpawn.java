...
public class BossSpawn
{
	...
	private static final String UPDATE_RAIDBOSS = "UPDATE raidboss_spawnlist SET respawn_time = ?, currentHP = ?, currentMP = ?, death_time = ? WHERE boss_id = ?";
	...
	private void updateOnDb()
	{
			...
			PreparedStatement ps = con.prepareStatement(UPDATE_RAIDBOSS))
		{
			...
			ps.setLong(4, _deathTime);
			ps.setInt(5, _spawn.getNpcId());
			ps.executeUpdate();
		}
		catch (Exception e)
		{
