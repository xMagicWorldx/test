...
public abstract class Playable extends Creature
{
	...
	public boolean canCastOffensiveSkillOnPlayable(Playable target, L2Skill skill, boolean isCtrlPressed)
	{
		...
		if (getActingPlayer().isInArena() && targetPlayer.isInArena() && !(sameParty || sameCommandChannel))
			return true;
	...
	public boolean isAttackableWithoutForceBy(Playable attacker)
	{
		...
		if (sameParty || sameCommandChannel || sameClan || sameAlliance || sameSiegeSide && !(attackerPlayer.isInsideZone(ZoneId.PVP)))
			return false;
