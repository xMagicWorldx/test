...
public class Npc extends Creature
{
	...
	protected void teleport(Player player, int index)
	{
		...
		if (Config.FREE_TELEPORT || player.getStatus().getLevel() <= Config.LVL_FREE_TELEPORT || teleport.getPriceCount() == 0 || player.destroyItemByItemId("InstantTeleport", teleport.getPriceId(), teleport.getPriceCount(), this, true))
			player.teleportTo(teleport, 20);
