...
public final class RequestJoinParty extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (targetEvent != null && targetEvent.isStarted() && target.getTeam() == null || target.getTeam().getId() > 0 && target.getTeam() != requestor.getTeam())
			return;
 		
		if (requestorEvent != null && requestorEvent.isStarted() && requestor.getTeam() == null || requestor.getTeam().getId() > 0 && requestor.getTeam() != target.getTeam())
		{
